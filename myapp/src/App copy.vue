...
//백엔드 서버로 부터 가지고 온 목록을 todolist에 넣어주어야함.
//화면에 toodList목록을 보일것임

const fetchTodoList = async () => {
  //axios 필요함 --> import 필요함
  try{
   
 let response = await axios.get(BASEURI); //http 통신(요청) --> http응답
...
fetchTodoList();//시작하자마자 함수를 호출하고 싶으면 바로 써주세요!
